...
|                                              |
|**********************************************/
void Reorganisation_TOVnC(char nom_fichier[], char nom_fichier1[], char nom_fichier2[], int *COUNT)
{
    ...
    ecrireDir_LOVC(&f2, i2, &Buf2, COUNT); // ecrire dernier buffer du fichier des materiaux en marche
    Fermer_TOVC(&f1);
    fermer_LOVC(&f2);
    Fermer_TOVnC(&f);
}
